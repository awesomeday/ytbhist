...
namespace YtbHistory
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var token = "4qmFsgIZEglGRWhpc3RvcnkaDENOT3QzNFA4ME5zQw%253D%253D";
            var continuation = "4qmFsgIZEglGRWhpc3RvcnkaDENMSzV5dWFDeTlzQw%253D%253D";

            var urlTemplate = "http://www.youtube.com/browse_ajax?ctoken={0}&continuation={1}&itct=CCEQybcCIhMI0c6p_Ovf3AIVDV-yCh3J5gtV";
            var url = String.Format(urlTemplate, token, continuation);
            ...
            // cnt.Headers.Add("Content-Length", "280");
            ...
            // cnt.Headers.Add("Content-Type", "application/x-www-form-urlencoded");
            ...
            var res = client.SendAsync(m).Result;
